    ...
    <div class="item-display">
      <div v-for="Item in Items" :key="Item.id">
        ...
        <transition name="slide" appear>
          ...
          <h1>{{myItem.caption}}</h1>
          <img :src="myItem.image" width="128" height="128" /><br/>
          <h4>Location: {{myItem.location.city}}, {{myItem.location.country}}</h4>
...
export default {
  ...
  mounted: function() {
    axios.get('http://freebay.pythonanywhere.com/api/v1/items/').then(response => this.Items = response.data);
  },
  computed: {
